...
public class EditraProvedor extends javax.swing.JFrame {

    public EditraProvedor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditraProvedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditraProvedor().setVisible(true);
            }
        });
    }
