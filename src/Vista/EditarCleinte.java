...
import Controlador.ControladorAfiliacion;
...
public class EditarCleinte extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(telefonoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 331, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void guardarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarClienteActionPerformed
        ...
        if (cedulaCliente.getText().equals("") || nombreCliente.getText().equals("")
            ...
            Controlador.ControladorAfiliacion editaAfiliacion = new ControladorAfiliacion();
            editaCliente.editarCliente(nombre, apellido, cedula, telefono, correo,sexo, estado);
            editaAfiliacion.editarAfiliacion(cedula, plan, estadoPlan);
